...
if DATABASE_URL:
    ...
    DATABASES["default"] = {
        ...
        "OPTIONS": {} if ("localhost" in DATABASE_URL or "127.0.0.1" in DATABASE_URL) else {"sslmode": "require"},
    }
...
POSTMARK_FROM_EMAIL = os.getenv("POSTMARK_FROM_EMAIL", DEFAULT_FROM_EMAIL)
